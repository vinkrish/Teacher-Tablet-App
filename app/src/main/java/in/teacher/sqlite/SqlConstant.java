...
public interface SqlConstant {
    ...
    public static String CREATE_SCHOOL = "CREATE TABLE school(SchoolId INTEGER PRIMARY KEY, SchoolName TEXT, Website TEXT, " +
    ...
    public static String CREATE_STUDENTS_TRIGGER = "CREATE TRIGGER before_students BEFORE INSERT ON students " +
    ...
    public static String CREATE_SUBJECTS = "CREATE TABLE subjects(SubjectId INTEGER, SchoolId INTEGER, SubjectName TEXT, " +
            "has_partition INTEGER, TheorySubjectId INTEGER, PracticalSubjectId INTEGER, DateTimeRecordInserted DATETIME)";

    public static String CREATE_SUB_GROUPS = "CREATE TABLE subjects_groups(id INTEGER, SchoolId INTEGER, " +
            "SubjectGroup TEXT, subject_ids TEXT, DateTimeRecordInserted DATETIME)";

    public static String CREATE_SUBJECT_TEACHER = "CREATE TABLE subjectteacher(id INTEGER, ClassId INTEGER, " +
    ...
    public static String CREATE_EXAMS = "CREATE TABLE exams(SchoolId INTEGER, ClassId INTEGER, ExamId INT DEFAULT 0, " +
    ...
    public static String CREATE_EXAMS_TRIGGER = "CREATE TRIGGER before_exams BEFORE INSERT ON exams " +
            "WHEN ((SELECT count() FROM exams WHERE exams.ExamId=NEW.ExamId) > 0) " +
            "BEGIN " +
            "DELETE FROM exams WHERE exams.ExamId=NEW.ExamId; " +
            "END";

    public static String CREATE_SUBJECT_EXAMS = "CREATE TABLE subjectexams(SchoolId INTEGER, ClassId INTEGER, " +
    ...
    public static String CREATE_MARKS = "CREATE TABLE marks(SchoolId INTEGER, ExamId INTEGER, Is_Present INTEGER, " +
    ...
    public static String CREATE_ACTIVITY = "CREATE TABLE activity(ActivityId INT DEFAULT 0, SchoolId INTEGER, " +
    ...
    public static String CREATE_ACTIVITY_TRIGGER = "CREATE TRIGGER before_activity BEFORE INSERT ON activity " +
    ...
    public static String CREATE_ACTIVITY_GRADE = "CREATE TABLE activitygrade(SchoolId INTEGER, ExamId INTEGER, SubjectId INTEGER," +
            "StudentId INTEGER, ActivityId INTEGER, Grade TEXT, DateTimeRecordInserted DATETIME, PRIMARY KEY(ActivityId, StudentId))";

    public static String ACTIVITYGRADE_TRIGGER = "CREATE TRIGGER before_actgrade BEFORE INSERT ON activitygrade " +
    ...
    public static String CREATE_SUB_ACTIVITY = "CREATE TABLE subactivity(SubActivityId INT DEFAULT 0, SchoolId INTEGER, " +
    ...
    public static String CREATE_SUB_ACTIVITY_TRIGGER = "CREATE TRIGGER before_subactivity BEFORE INSERT ON subactivity " +
    ...
    public static String CREATE_SUB_ACTIVITY_MARK = "CREATE TABLE subactivitymark(SchoolId INTEGER, ExamId INTEGER, " +
    ...
    public static String CREATE_SUB_ACTIVITY_GRADE = "CREATE TABLE subactivitygrade(SchoolId INTEGER, ExamId INTEGER, SubjectId INTEGER," +
            "StudentId INTEGER, ActivityId INTEGER, SubActivityId INTEGER, Grade TEXT, Description TEXT, " +
            "DateTimeRecordInserted DATETIME, PRIMARY KEY(SubActivityId, StudentId))";

    public static String SUBACTGRADE_TRIGGER = "CREATE TRIGGER before_subactgrade BEFORE INSERT ON subactivitygrade " +
    ...
    public static String CREATE_PORTION = "CREATE TABLE portion(PortionId INT DEFAULT 0, SchoolId INTEGER, ClassId INTEGER, " +
            "SubjectId INTEGER, NewSubjectId INTEGER, Portion TEXT, DateTimeRecordInserted DATETIME)";

    public static String CREATE_SLIPTEST = "CREATE TABLE sliptest(SlipTestId INTEGER PRIMARY KEY, SchoolId INTEGER, " +
    ...
    public static String CREATE_HOMEWORK = "CREATE TABLE homeworkmessage(HomeworkId INTEGER, SchoolId TEXT, ClassId TEXT, " +
    ...
    public static String CREATE_EXMAVG = "CREATE TABLE exmavg(ClassId INTEGER, SectionId INTEGER, SubjectId INTEGER, " +
            "ExamId INTEGER, ExamAvg REAL DEFAULT 0, CompleteEntry INTEGER DEFAULT 0, PRIMARY KEY(SectionId, SubjectId, ExamId))";

    public static String CREATE_STAVG = "CREATE TABLE stavg(ClassId INTEGER, SectionId INTEGER, SubjectId INTEGER, " +
            "SlipTestAvg REAL DEFAULT 0, PRIMARY KEY(SectionId, SubjectId))";

    public static String CREATE_GCW = "CREATE TABLE gradesclasswise(GradeId INTEGER, SchoolId INTEGER, ClassId INTEGER, " +
            "Grade TEXT, MarkFrom INTEGER, MarkTo INTEGER, GradePoint INTEGER, DateTimeRecordInserted DATETIME)";

    public static String CREATE_CCECOSCHOLASTIC = "CREATE TABLE ccecoscholastic(CoScholasticId INTEGER, SchoolId INTEGER, " +
            "Name TEXT, ClassIDs TEXT, DateTimeRecordInserted DATETIME)";

    public static String CREATE_CCESECTIONHEADING = "CREATE TABLE ccesectionheading(SectionHeadingId INTEGER, SchoolId INTEGER, " +
            "CoScholasticId INTEGER, SectionName TEXT, DateTimeRecordInserted DATETIME)";

    public static String CREATE_CCETOPICPRIMARY = "CREATE TABLE ccetopicprimary(TopicId INTEGER, SchoolId INTEGER, " +
            "CoScholasticId INTEGER, SectionHeadingId INTEGER, TopicName TEXT, Evaluation INTEGER, DateTimeRecordInserted DATETIME)";

    public static String CREATE_CCEASPECTPRIMARY = "CREATE TABLE cceaspectprimary(AspectId INTEGER, SchoolId INTEGER, " +
            "CoScholasticId INTEGER, SectionHeadingId INTEGER, TopicId INTEGER, AspectName TEXT, DateTimeRecordInserted DATETIME)";

    public static String CREATE_CCETOPICGRADE = "CREATE TABLE ccetopicgrade(ccetopicgradeid INTEGER, SchoolId INTEGER, " +
            "TopicId INTEGER, Grade TEXT, Value INTEGER, CoScholasticId INTEGER, SectionHeadingId INTEGER)";

    public static String CREATE_CCECOSCHOLASTICGRADE = "CREATE TABLE ccecoscholasticgrade(Id INTEGER, SchoolId INTEGER, " +
    ...
    public static String CREATE_DOWNLOADED_FILE = "CREATE TABLE downloadedfile(id INTEGER PRIMARY KEY, filename TEXT UNIQUE, " +
            "downloaded INTEGER DEFAULT 0, processed INTEGER DEFAULT 0, isack INTEGER DEFAULT 0)";

    public static String CREATE_UPLOADED_FILE = "CREATE TABLE uploadedfile(id INTEGER PRIMARY KEY, filename TEXT UNIQUE, " +
            "processed INTEGER DEFAULT 0)";

    public static String CREATE_AVGTRACK = "CREATE TABLE avgtrack(ExamId INTEGER DEFAULT 0, ActivityId INTEGER DEFAULT 0, " +
            "SubActivityId INTEGER DEFAULT 0, SubjectId INTEGER DEFAULT 0, SectionId INTEGER DEFAULT 0, Type INTEGER)";

    public static String CREATE_LOCKED = "CREATE TABLE locked(FileName TEXT UNIQUE, LineNumber INTEGER, StackTrace TEXT, " +
            "IsSent INTEGER DEFAULT 0)";

    public static String CREATE_CCE_STUDENT_PROFILE = "CREATE TABLE ccestudentprofile(CceId INTEGER, SchoolId TEXT, " +
    ...
    public static String CREATE_TIMETABLE = "CREATE TABLE timetable(SchoolId INTEGER, ClassId INTEGER, SectionId INTEGER, " +
