...
public class TempDao {
    ...
    public static Temp selectTemp(SQLiteDatabase sqliteDatabase) {
        ...
        while (!c.isAfterLast()) {
            ...
            t.setStudentId(c.getLong(c.getColumnIndex("StudentId")));
    ...
    public static void updateCurrentClass(int classId, SQLiteDatabase sqliteDatabase){
        ContentValues cv = new ContentValues();
        cv.put("CurrentClass", classId);
    ...
    public static void updateStudentId(long studentId, SQLiteDatabase sqliteDatabase) {
        ContentValues cv = new ContentValues();
